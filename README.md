...
1. 在 OBS 中添加「瀏覽器」源
2. URL 設為：`http://localhost:8080`
3. 寬度：800，高度：600
4. 勾選「控制音訊（透過OBS）」

### 自訂樣式

可以修改 `frontend/css/styles.css` 來調整 OBS 顯示效果。
...
2. **定期檢查**：監控系統日誌和 Binance API 狀態  
3. **備用方案**：保持 BSC 監聽功能作為備用
4. **安全實踐**：定期更換 API 金鑰，使用子帳戶
